...
def main(input: str, output: str):
    ...
    yaml_path = os.path.join(input,"chem.yaml")
    transport_path = os.path.join(input, "transportProperties")
...
if __name__ == "__main__":
    ...
    #     thermo_only = True
    # input = sys.argv[1]
    # output = sys.argv[2] if len(sys.argv) > 2 else "./test/"
    input = sys.argv[1]
    output = sys.argv[2]
    main(input, output)
